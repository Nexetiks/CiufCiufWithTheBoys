...
namespace Destructible2D
{
    ...
    public class D2dRequirements : MonoBehaviour
    {
        ...
        public float AlphaCountMin
        {
            set { alphaCountMin = value; }
            get { return alphaCountMin; }
        }

        [SerializeField]
        private float alphaCountMin;

        /// <summary>The D2dDestructible.AlphaCount value must be below this value.</summary>
        public float AlphaCountMax
        {
            set { alphaCountMax = value; }
            get { return alphaCountMax; }
        }

        [SerializeField]
        private float alphaCountMax;

        /// <summary>If you enable this then the D2dDestructible.AlphaRatio value will be checked.</summary>
        public bool AlphaRatio
        {
            set { alphaRatio = value; }
            get { return alphaRatio; }
        }

        [SerializeField]
        private bool alphaRatio;

        /// <summary>The D2dDestructible.AlphaRatio value must be at or above this value.</summary>
        public float AlphaRatioMin
        {
            set { alphaRatioMin = value; }
            get { return alphaRatioMin; }
        }

        [SerializeField]
        private float alphaRatioMin;

        /// <summary>The D2dDestructible.AlphaRatio value must be below this value.</summary>
        public float AlphaRatioMax
        {
            set { alphaRatioMax = value; }
            get { return alphaRatioMax; }
        }

        [SerializeField]
        private float alphaRatioMax;
        ...
        public UnityEvent OnRequirementsMet
        {
            get
            {
                if (onRequirementsMet == null) onRequirementsMet = new UnityEvent();
                return onRequirementsMet;
            }
        }

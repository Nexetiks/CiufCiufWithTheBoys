...
namespace Destructible2D
{
    ...
    public class D2dFixtureJoint : MonoBehaviour
    {
        ...
        [SerializeField]
        private D2dFixture fixture;

        /// <summary>This is the fixture associated with the object the current joint attaches to.</summary>
        public D2dFixture ConnectedFixture
        {
            set { connectedFixture = value; }
            get { return connectedFixture; }
        }

        [SerializeField]
        private D2dFixture connectedFixture;

        /// <summary>Automatically destroy this joint if detached?</summary>
        public bool AutoDestroyJoint
        {
            set { autoDestroyJoint = value; }
            get { return autoDestroyJoint; }
        }

        [SerializeField]
        private bool autoDestroyJoint = true;

        /// <summary>Automatically destroy this component if detached?</summary>
        public bool AutoDestroyThis
        {
            set { autoDestroyThis = value; }
            get { return autoDestroyThis; }
        }

        [SerializeField]
        private bool autoDestroyThis = true;

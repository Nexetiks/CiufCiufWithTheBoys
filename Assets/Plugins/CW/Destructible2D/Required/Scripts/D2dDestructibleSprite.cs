...
namespace Destructible2D
{
    ...
    public class D2dDestructibleSprite : D2dDestructible
    {
        ...
        public Sprite SolidRangeMask
        {
            set { solidRangeMask = value; }
            get { return solidRangeMask; }
        }

        [SerializeField]
        private Sprite solidRangeMask;
        ...
        public ChannelType ChannelsRaw
        {
            set { channels = value; }
            get { return channels; }
        }
        ...
        public bool CropSprite
        {
            ...
            get { return cropSprite; }
        }

        [SerializeField]
        private bool cropSprite = true;

        /// <summary>To save scene file size you can Clear your destructible, and allow it to Rebuilt on Start.</summary>
        public bool RebuildInGame
        {
            set { rebuildInGame = value; }
            get { return rebuildInGame; }
        }

        [SerializeField]
        private bool rebuildInGame;

        /// <summary>This allows you to set how many times the rebuilt alpha data will be optimized when rebuilt on Start.</summary>
        public int RebuildOptimizeCount
        {
            set { rebuildOptimizeCount = value; }
            get { return rebuildOptimizeCount; }
        }

        [SerializeField]
        private int rebuildOptimizeCount;
        ...
        {
            get { return CachedSpriteRenderer; }
        }
        ...
        {
            get { return channels == ChannelType.AlphaOnly ? TextureFormat.Alpha8 : TextureFormat.ARGB32; }
        }

...
namespace Destructible2D
{
    ...
    public static class D2dEdgeSquares
    {
        ...
        public static void CalculateCells()
        {
            ...
            var reserve = squaresH * squaresV - squares.Count;
            for (var i = reserve; i > 0; i--) squares.Add(new Square());
            var index = 0;
            ...
            {
                var bl = GetPolyAlpha(MinX, y);
                var useBl = bl >= 128;
                var tl = GetPolyAlpha(MinX, y + 1);
                var useTl = tl >= 128;

                for (var x = MinX; x < MaxX - 1; x++)
                {
                    var square = squares[index++];
                    var br = GetPolyAlpha(x + 1, y);
                    var useBr = br >= 128;
                    var tr = GetPolyAlpha(x + 1, y + 1);
                    var useTr = tr >= 128;
        ...
        private static void DoTrace(Square square)
        {
            switch (square.Mask)
            {
                case 1:
                    square.Mask = 0;
                    DoTrace(square, Side.W, true);
                    DoTrace(square, Side.S, false);
                    break;

                case 2:
                    square.Mask = 0;
                    DoTrace(square, Side.S, true);
                    DoTrace(square, Side.E, false);
                    break;
                ...
                case 4:
                    square.Mask = 0;
                    DoTrace(square, Side.N, true);
                    DoTrace(square, Side.W, false);
                    break;
                ...
                case 8:
                    square.Mask = 0;
                    DoTrace(square, Side.E, true);
                    DoTrace(square, Side.N, false);
                    break;
        ...
        private static void DoTrace(Square square, Side side, bool end)
        {
            ...
            {
                case Side.W:
                    AddPoint(square.PointW, end);
                    DoTrace(square.X - 1, square.Y, Side.E, end);
                    break;

                case Side.E:
                    AddPoint(square.PointE, end);
                    DoTrace(square.X + 1, square.Y, Side.W, end);
                    break;

                case Side.S:
                    AddPoint(square.PointS, end);
                    DoTrace(square.X, square.Y - 1, Side.N, end);
                    break;

                case Side.N:
                    AddPoint(square.PointN, end);
                    DoTrace(square.X, square.Y + 1, Side.S, end);
                    break;
            }
        }
            ...
            while (true)
            {
                ...
                switch (square.Mask)
                {
                    ...
                    case 1:
                        if (side == Side.W)
                        {
                            ShiftS(square, end, ref x, ref y, ref side);
                            square.Mask = 0;
                            continue;
                        }
                        ...
                        if (side == Side.S)
                        {
                            ShiftW(square, end, ref x, ref y, ref side);
                            square.Mask = 0;
                            continue;
                        }
                    ...
                    case 2:
                        if (side == Side.S)
                        {
                            ShiftE(square, end, ref x, ref y, ref side);
                            square.Mask = 0;
                            continue;
                        }
                    ...
                    case 4:
                        ...
                        if (side == Side.W)
                        {
                            ShiftN(square, end, ref x, ref y, ref side);
                            square.Mask = 0;
                            continue;
                        }

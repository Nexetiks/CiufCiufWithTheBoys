...
namespace Destructible2D
{
    ...
    public abstract class D2dCollider : MonoBehaviour
    {
        ...
        public void SetMaterial(PhysicsMaterial2D value)
        {
            material = value;
        }
        ...
        {
            get { return TryGetComponent(out cachedRigidbody) == true && cachedRigidbody.useAutoMass == true; }
        }

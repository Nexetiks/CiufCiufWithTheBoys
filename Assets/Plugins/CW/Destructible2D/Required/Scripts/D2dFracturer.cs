...
namespace Destructible2D
{
    ...
    public class D2dFracturer : MonoBehaviour
    {
        ...
        {
            set { damageRequired = value; }
            get { return damageRequired; }
        }

        [SerializeField]
        private float damageRequired = 100.0f;
        ...
        public float PointsPerSolidPixel
        {
            set { pointsPerSolidPixel = value; }
            get { return pointsPerSolidPixel; }
        }

        [SerializeField]
        private float pointsPerSolidPixel = 0.001f;
        ...
        public bool FactorInSharpness
        {
            set { factorInSharpness = value; }
            get { return factorInSharpness; }
        }

        [SerializeField]
        private bool factorInSharpness = true;
        ...
        {
            set { splitAfterFracture = value; }
            get { return splitAfterFracture; }
        }

        [SerializeField]
        private bool splitAfterFracture;

        /// <summary>This allows you to set the Feather value used when splitting.</summary>
        public int SplitFeather
        {
            set { splitFeather = value; }
            get { return splitFeather; }
        }

        [SerializeField]
        private int splitFeather = 3;

        /// <summary>This allows you to set the HealThreshold value used when splitting.</summary>
        public int SplitHealThreshold
        {
            set { splitHealThreshold = value; }
            get { return splitHealThreshold; }
        }

        [SerializeField]
        private int splitHealThreshold = -1;

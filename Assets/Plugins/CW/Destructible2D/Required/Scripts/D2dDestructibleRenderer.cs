...
namespace Destructible2D
{
    ...
    public class D2dDestructibleRenderer : D2dDestructible
    {
        ...
        public List<Material> OriginalMaterials
        {
            get
            {
                if (originalMaterials == null) originalMaterials = new List<Material>();
        ...
        [SerializeField]
        private ChannelType channels = ChannelType.AlphaWithWhiteRGB;
        ...
        public int RebuildLayer
        {
            set { rebuildLayer = value; }
            get { return rebuildLayer; }
        }

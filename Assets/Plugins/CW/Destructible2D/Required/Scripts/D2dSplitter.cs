...
namespace Destructible2D
{
    ...
    public class D2dSplitter : MonoBehaviour
    {
        ...
        {
            set { healThreshold = value; }
            get { return healThreshold; }
        }

        [SerializeField]
        private int healThreshold = -1;
                ...
                if (islands.Count > 1)
                {
                    ...
                    else
                    {
                        ...
                        for (var i = islands.Count - 1; i >= 0; i--)
                        {
                            ...
                            var rect = new D2dRect(island.MinX, island.MaxX, island.MinY, island.MaxY);
                            rect.ClampTo(baseRect);

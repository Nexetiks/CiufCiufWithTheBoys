...
namespace Destructible2D.Examples
{
    ...
    public class D2dTapToRead : MonoBehaviour
    {
        ...
        [Serializable]
        public class D2dDestructibleColorEvent : UnityEvent<D2dDestructible, Color>
        {
        };
        ...
        public ColorEvent OnColor
        {
            get
            {
                if (onColor == null) onColor = new ColorEvent();
                return onColor;
            }
        }
        ...
        public D2dDestructibleColorEvent OnDestructibleColor
        {
            get
            {
                if (onDestructibleColor == null) onDestructibleColor = new D2dDestructibleColorEvent();
                return onDestructibleColor;
            }
        }

        [SerializeField]
        private D2dDestructibleColorEvent onDestructibleColor;

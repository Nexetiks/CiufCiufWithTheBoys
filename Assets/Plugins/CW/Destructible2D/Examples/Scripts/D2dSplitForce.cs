...
namespace Destructible2D.Examples
{
    ...
    public class D2dSplitForce : MonoBehaviour
    {
        ...
        public D2dDestructible.SplitMode ApplyTo
        {
            set { applyTo = value; }
            get { return applyTo; }
        }
        ...
        [SerializeField]
        private D2dDestructible.SplitMode applyTo = D2dDestructible.SplitMode.Fracture;
        ...
        public float ForcePerSolidPixel
        {
            set { forcePerSolidPixel = value; }
            get { return forcePerSolidPixel; }
        }

        [SerializeField]
        private float forcePerSolidPixel = 0.01f;
